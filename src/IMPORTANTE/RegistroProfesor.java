...
UsuariosDao login = new UsuariosDao();
    ...
    public void deleteplaceholder(JTextField textField){
     ...
     public void validarProfesor(){
        ...
        if(!"".equals(usu)||!"".equals(numFic) || !"".equals(pass) || !"".equals(nom)|| !"".equals(carrera)){
          ...
          login.RegistrarUsuarioProfesor(lg);
    ...
    private void initComponents() {
        ...
        cbxRol.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Profesor", "Jefe", "Servicio Social", "Invitado" }));
        ...
        jLabel8.setText("Registrarse Profesor");
